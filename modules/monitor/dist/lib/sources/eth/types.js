...
const hasAbi = (p) => ("abi" in p && Array.isArray(p.abi));
...
const hasTriggerValue = (p) => ("triggerValue" in p && (["bigint", "string", "number"].includes(typeof p.triggerValue) || utils_1.isBytesLike(p.triggerValue) || ethers_1.BigNumber.isBigNumber(p.triggerValue)));
